...
The next section will explain about our robot mechanical and electrical design. In section 3 is about software architecture and also includes new object recognition algorithm and new voice system. Section 4 will explained is about controlling robot movement, such as, motor control component and new manipulator handle component. Finally in the last section, we will present the conclusion.
